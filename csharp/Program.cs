...
public class Program
{
    ...
    // The Book class represents a row in the "books" table.
    private class Book
    {
    ...
    // Harden the database path to work consistently across different environments.
    ...
    private static void ReportBooks()
    {
        ...
        // Report by Genre using LINQ GroupBy
        Console.WriteLine("\n By Genre:");
        ...
        // Report by Author using LINQ GroupBy
        Console.WriteLine("\n By Author:");
    ...
    // Centralized method to retrieve all books from the database.
